...
socialminer.chat = function()
{
    ...
    poll = function ()
    {
        ...
        $.ajax(
			...
			if ( console && console.log ) {
			  console.log( "GET Sample of data:", data );
			}
		  });
    ...
    return {
        ...
        init: function (socialMinerBaseUrl, chatFeedRefUrl)
        {
            ...
            //chatUrl= "https://social.jarviscars.com.au/ccp/chat/";
			//chatGetUrl= "https://social.jarviscars.com.au/ccp/chat";
        ...
        send: function (message, success, error)
        {
			...
			if ( console && console.log ) {
			  console.log( "put Sample of data:", data );
			}
		  });
        ...
        initiate: function (contact, success, error)
        {
			...
			if ( console && console.log ) {
			  console.log( "POST Sample of data:", data );
			}
		  });
